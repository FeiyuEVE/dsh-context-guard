...
// Keeps src/client.js as human-readable source; lib/client.js is the bounded
// runtime artifact committed to git (same contract as dsh-cost-meter).
// Reproducible prepare contract: `node scripts/build.mjs` (requires esbuild,
// pinned via devDependencies).
